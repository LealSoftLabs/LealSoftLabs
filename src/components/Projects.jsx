...
export default function Projects() {
  ...
  return (
    <section id="projetos" className="section-padding bg-bg-secondary relative overflow-hidden">
      ...
      <div ref={ref} className={`max-w-7xl mx-auto transition-all duration-700 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
        ...
        <div className="text-center max-w-2xl mx-auto mb-16">
          ...
          <h2 className="section-title mt-6 mb-4">
            Cases que{' '}
            <span className="blue-glow-text">falam por si.</span>
          </h2>
          <p className="section-subtitle">
            Sistemas reais, entregues com qualidade, design e foco em desempenho.
          </p>
        </div>
              ...
              <div className="grid grid-cols-2 gap-2 mb-6">
                {project.features.map((feat) => (
                  <div key={feat} className="flex items-center gap-2">
                    ...
                    />
                    <span className="font-dm text-xs text-text-secondary">{feat}</span>
                  </div>
                ))}
              </div>
        ...
        <div className="text-center mt-12">
          <p className="font-dm text-text-secondary mb-4">Quer um sistema assim para o seu negócio?</p>
